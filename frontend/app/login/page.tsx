    ...
    <div className="min-h-screen flex items-center justify-center quant-grid">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="quant-chip text-xs uppercase tracking-[0.3em] px-4 py-1 rounded-full text-mono inline-block mb-4">
            Quant Edge
          </div>
          <h1 className="text-5xl font-bold text-white mb-2">HoopsQuant</h1>
          <p className="text-slate-400 text-lg">Smart NBA betting predictions & arbitrage</p>
        </div>

        {/* Auth Card */}
        <div className="quant-panel rounded-2xl p-8 space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#0f1626] text-gray-400">Or try the demo</span>
            </div>
          </div>
