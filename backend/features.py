...
print("[FEAT] Obliczanie Elo ratings z regresją do średniej...")
...
'''
LogReg_C_0.1 (Silna regularyzacja)  0.2160  0.7127     65.66%
LogReg_C_0.01 (Bardzo silna)        0.2151  0.7142     65.78%

✅ Najlepszy model: LogReg_C_0.01 (Bardzo silna)

============================================================
WAGI CECH (FEATURE IMPORTANCE) NAJLEPSZEGO MODELU
============================================================
Dodatnia waga (+) -> Zwiększa szansę gospodarza
Ujemna waga (-) -> Zmniejsza szansę gospodarza

                 Feature    Weight
0               elo_diff  0.246316
1               home_elo  0.229680
2               away_elo -0.125290
3       home_drtg_last10 -0.114662
4         away_ts_last10 -0.094250
5       away_drtg_last10  0.079927
6   away_tov_rate_last10  0.061437
7        away_efg_last10 -0.054389
8       home_ortg_last10  0.053607
9       away_ortg_last10 -0.053071
10       home_reb_last10  0.047500
11      away_pace_last10  0.047164
12       away_stl_last10 -0.046097
13       home_efg_last10  0.041524
14       away_blk_last10 -0.041385
